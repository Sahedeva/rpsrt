...
Meteor.methods({
	...
	computerUpdate: function() {
		...
		Players.update({'hal': 'yes'}, {$set: {rock_class: "rps_show", paper_class: "rps_show", scissors_class: "rps_show"}});
		Players.update({'userId': currentUserId}, {$set: {computer: true, player: 'player1', rock_class: "rps_show", paper_class: "rps_show", scissors_class: "rps_show",ready_class: 'countdown_show', countone_class: 'countdown_none', counttwo_class: 'countdown_none', countthree_class: 'countdown_none', go_class: 'countdown_none', win_class: 'countdown_none', lose_class: 'countdown_none', tie_class: 'countdown_none', clicked: 'no'} });
	},
