...
Meteor.methods({
	...
	computerUpdate: function() {
		...
		var currentUserId = Meteor.userId();
		Players.update({'userId': currentUserId}, {$set: {player: 'player1', rock_class: "rps_show", paper_class: "rps_show", scissors_class: "rps_show",ready_class: 'countdown_show', countone_class: 'countdown_none', counttwo_class: 'countdown_none', countthree_class: 'countdown_none', go_class: 'countdown_none', win_class: 'countdown_none', lose_class: 'countdown_none', tie_class: 'countdown_none', clicked: 'no'} });
	},
	humanUpdate: function() {
		check(Meteor.userId(), String);
		console.log("hitting humanUpdate");
		var currentUserId = Meteor.userId();
		Players.update({'userId': currentUserId}, {$set: {lobby: false, active: false, rock_class: "rps_show", paper_class: "rps_show", scissors_class: "rps_show",ready_class: 'countdown_show', countone_class: 'countdown_none', counttwo_class: 'countdown_none', countthree_class: 'countdown_none', go_class: 'countdown_none', win_class: 'countdown_none', lose_class: 'countdown_none', tie_class: 'countdown_none', win: 0, loss: 0, tie: 0, choice: '', another: 'hidden'} });
	},
  ...
  $set: {rock_class: "rps_show", paper_class: "rps_show", scissors_class: "rps_show",ready_class: 'countdown_show', countone_class: 'countdown_none', counttwo_class: 'countdown_none', countthree_class: 'countdown_none', go_class: 'countdown_none', win_class: 'countdown_none', lose_class: 'countdown_none', tie_class: 'countdown_none', choice: '', another: 'hidden'} });
		Players.update({'userId': opponent_id}, {
  $set: {rock_class: "rps_show", paper_class: "rps_show", scissors_class: "rps_show",ready_class: 'countdown_show', countone_class: 'countdown_none', counttwo_class: 'countdown_none', countthree_class: 'countdown_none', go_class: 'countdown_none', win_class: 'countdown_none', lose_class: 'countdown_none', tie_class: 'countdown_none', choice: '', another: 'hidden'} });
	},
  ...
  $set: {reject: "show", challenger_name: challenger_name} });
	...
	playerActiveUpdate: function(opponent_id) {
		...
		console.log("Active update currentUserId: " + currentUserId);
		Players.update({'userId': currentUserId}, {
  $set: {active: true, lobby: false, challenge: "show", accept: "hidden", opponent_id: opponentId} });
		Players.update({'userId': opponentId}, {
  $set: {active: true, lobby: false, challenge: "show", accept: "hidden", opponent_id: currentUserId} });
		// Router.go('/human');
	},
